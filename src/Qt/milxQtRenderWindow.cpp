...
void milxQtRenderWindow::createActions()
{
    ...
    contextMenu->setTitle(QApplication::translate("MainWindow", "Rendering", 0));

    contourAct = new QAction(this);
    contourAct->setText(QApplication::translate("Render", "Contour Mode", 0));
    contourAct->setCheckable(true);
    contourAct->setChecked(false);
    contourPolyDataAct = new QAction(this);
    contourPolyDataAct->setText(QApplication::translate("Render", "Create Model From Contour", 0));
    contourNodePolyDataAct = new QAction(this);
    contourNodePolyDataAct->setText(QApplication::translate("Render", "Save Contour", 0));
    contourInitAct = new QAction(this);
    contourInitAct->setText(QApplication::translate("Render", "Load Contour", 0));
//    contourImageAct = new QAction(this);
//    contourImageAct->setText(QApplication::translate("Render", "Create Binary Image From Contour", 0));

    contourMenu = new QMenu(this);
    contourMenu->setTitle(QApplication::translate("Render", "Contouring", 0));
...
//    contourMenu->addAction(contourImageAct);
    ...
    viewXY->setText(QApplication::translate("Render", "Axial (xy-plane)", 0));
    viewXY->setShortcut(tr("Alt+a"));
    viewXY->setCheckable(true);
    viewXY->setChecked(true);
    viewZX = new QAction(this);
    viewZX->setText(QApplication::translate("Render", "Coronal (zx-plane)", 0));
    viewZX->setShortcut(tr("Alt+c"));
    viewZX->setCheckable(true);
    viewZY = new QAction(this);
    viewZY->setText(QApplication::translate("Render", "Sagittal (zy-plane)", 0));
    viewZY->setShortcut(tr("Alt+s"));
    viewZY->setCheckable(true);
    saveViewAct = new QAction(this);
    saveViewAct->setText(QApplication::translate("Render", "Save View", 0));
    saveViewAct->setShortcut(tr("Ctrl+Alt+s"));
    loadViewAct = new QAction(this);
    loadViewAct->setText(QApplication::translate("Render", "Load View", 0));
    loadViewAct->setShortcut(tr("Ctrl+Alt+l"));
    saveViewFileAct = new QAction(this);
    saveViewFileAct->setText(QApplication::translate("Render", "Save View to File", 0));
    saveViewFileAct->setShortcut(tr("Shift+Alt+s"));
    loadViewFileAct = new QAction(this);
    loadViewFileAct->setText(QApplication::translate("Render", "Load View from File", 0));
    loadViewFileAct->setShortcut(tr("Shift+Alt+l"));
    scaleAct = new QAction(this);
    scaleAct->setText(QApplication::translate("Render", "&Scalar Bar", 0));
    ...
    actionDefault->setText(QApplication::translate("Render", "None", 0));
...
//    actionJet->setText(QApplication::translate("Render", "Jet", 0));
...
//    actionRainbow->setText(QApplication::translate("Render", "Rainbow", 0));
...
//    actionInvRainbow->setText(QApplication::translate("Render", "VTK", 0));
...
//    actionGray->setText(QApplication::translate("Render", "Gray", 0));
...
//    actionLogGray->setText(QApplication::translate("Render", "Gray (Log 10)", 0));
...
//    actionNIH->setText(QApplication::translate("Render", "NIH", 0));
...
//    actionNIH_FIRE->setText(QApplication::translate("Render", "NIH Fire", 0));
...
//    actionAAL->setText(QApplication::translate("Render", "AAL", 0));
...
//    actionFS->setText(QApplication::translate("Render", "FreeSurfer", 0));
...
//    actionHOT->setText(QApplication::translate("Render", "HOT", 0));
...
//    actionCOOL->setText(QApplication::translate("Render", "COOL", 0));
...
//    actionCOOLWARM->setText(QApplication::translate("Render", "COOL-WARM", 0));
...
//    actionKnee->setText(QApplication::translate("Render", "Knee", 0));
...
//    actionBone->setText(QApplication::translate("Render", "Bone", 0));
...
//    actionSpectral->setText(QApplication::translate("Render", "Spectral", 0));
...
//    actionGNUPlot->setText(QApplication::translate("Render", "GNUPlot", 0));
...
//    actionCubeHelix->setText(QApplication::translate("Render", "CubeHelix", 0));
//    actionCubeHelix->setIcon(QIcon(":resources/cmaps/cm_gnuplot.png"));
    ...
    refreshAct->setText(QApplication::translate("Render", "&Refresh", 0));
    refreshAct->setShortcut(tr("F5"));
    resetAct = new QAction(this);
    resetAct->setText(QApplication::translate("Render", "Reset", 0));
