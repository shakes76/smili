...
int main(int argc, char *argv[])
{
  ...
  ValueArg<std::string> outputFormatArg("", "outputformat", "Specify the default output format for multiple outputs (vtk, vtp, ply, stl etc., default: same as input)", false, "vtk", "Output format");
