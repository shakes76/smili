...
void milxQtImage::createActions()
{
    ...
    operateMenu->setTitle(QApplication::translate("Image", "Operations", 0));
    rescaleAct = new QAction(this);
    rescaleAct->setText(QApplication::translate("Image", "Rescale Intensities", 0));
    rescaleAct->setShortcut(tr("Alt+r"));
    equaliseAct = new QAction(this);
    equaliseAct->setText(QApplication::translate("Image", "Histogram Equalisation", 0));
    equaliseAct->setShortcut(tr("Alt+h"));
    computeContourAct = new QAction(this);
    computeContourAct->setText(QApplication::translate("Image", "Compute Contour", 0));
    computeContourAct->setShortcut(tr("Alt+m"));
    smoothAct = new QAction(this);
    smoothAct->setText(QApplication::translate("Image", "Smooth via Anisotropic Diffusion", 0));
    smoothAct->setShortcut(tr("Alt+s"));
    gaussianAct = new QAction(this);
    gaussianAct->setText(QApplication::translate("Image", "Smooth via Gaussian Convolution", 0));
    gaussianAct->setShortcut(tr("Alt+c"));
    bilateralAct = new QAction(this);
    bilateralAct->setText(QApplication::translate("Image", "Smooth via Bilateral Filter", 0));
    bilateralAct->setShortcut(tr("Alt+b"));
    medianAct = new QAction(this);
    medianAct->setText(QApplication::translate("Image", "Smooth via Median", 0));
    medianAct->setShortcut(tr("Shift+Alt+s"));
    gradMagAct = new QAction(this);
    gradMagAct->setText(QApplication::translate("Image", "Gradient Magnitude", 0));
    gradMagAct->setShortcut(tr("Alt+g"));
    sobelAct = new QAction(this);
    sobelAct->setText(QApplication::translate("Image", "Sobel Edge Detection", 0));
    sobelAct->setShortcut(tr("Alt+e"));
    cannyAct = new QAction(this);
    cannyAct->setText(QApplication::translate("Image", "Canny Edge Detection", 0));
    cannyAct->setShortcut(tr("Shift+Alt+e"));
    laplacianAct = new QAction(this);
    laplacianAct->setText(QApplication::translate("Image", "Apply Laplacian", 0));
    laplacianAct->setShortcut(tr("Alt+l"));
    highPassAct = new QAction(this);
    highPassAct->setText(QApplication::translate("Image", "Butterworth High-Pass Filter", 0));
    highPassAct->setShortcut(tr("Shift+Alt+b"));
    normAct = new QAction(this);
    normAct->setText(QApplication::translate("Image", "Normalize", 0));
    normAct->setShortcut(tr("Alt+n"));
    invertAct = new QAction(this);
    invertAct->setText(QApplication::translate("Image", "Invert Intensities", 0));
    invertAct->setShortcut(tr("Alt+v"));
    relabelAct = new QAction(this);
    relabelAct->setText(QApplication::translate("Image", "Relabel", 0));
    relabelAct->setShortcut(tr("Shift+Alt+l"));
    //Transform
    transformMenu = new QMenu(this);
    transformMenu->setTitle(QApplication::translate("Image", "Transforms", 0));
    matchAct = new QAction(this);
    matchAct->setText(QApplication::translate("Image", "Match Information to ...", 0));
    matchAct->setShortcut(tr("Shift+Alt+i"));
    matchHistAct = new QAction(this);
    matchHistAct->setText(QApplication::translate("Image", "Match Histogram to ...", 0));
    matchHistAct->setShortcut(tr("Shift+Alt+h"));
    resampleSpacingAct = new QAction(this);
    resampleSpacingAct->setText(QApplication::translate("Image", "Resample to spacing ...", 0));
    resampleSpacingAct->setShortcut(tr("Ctrl+Alt+r"));
    resampleAct = new QAction(this);
    resampleAct->setText(QApplication::translate("Image", "Resample Image to ...", 0));
    resampleAct->setShortcut(tr("Shift+Alt+r"));
    resampleLabelAct = new QAction(this);
    resampleLabelAct->setText(QApplication::translate("Image", "Resample as Labelled Image to ...", 0));
    resampleLabelAct->setShortcut(tr("Shift+Alt+l"));
    subsampleAct = new QAction(this);
    subsampleAct->setText(QApplication::translate("Image", "Subsample Image", 0));
    subsampleAct->setShortcut(tr("Shift+Alt+s"));
    transformAct = new QAction(this);
    transformAct->setText(QApplication::translate("Image", "Transform via File ...", 0));
    transformAct->setShortcut(tr("Shift+Alt+t"));
    maskAct = new QAction(this);
    maskAct->setText(QApplication::translate("Image", "Mask Image with ...", 0));
    maskAct->setShortcut(tr("Shift+Alt+m"));
    cropAct = new QAction(this);
    cropAct->setText(QApplication::translate("Image", "Mask and Crop Image with ...", 0));
    cropAct->setShortcut(tr("Shift+Alt+a"));
    checkerAct = new QAction(this);
    checkerAct->setText(QApplication::translate("Image", "Compare as Checkboard to ...", 0));
    checkerAct->setShortcut(tr("Shift+Alt+c"));
    distMapAct = new QAction(this);
    distMapAct->setText(QApplication::translate("Image", "Distance Map", 0));
    distMapAct->setShortcut(tr("Alt+d"));
    flipAct = new QAction(this);
    flipAct->setText(QApplication::translate("Image", "Flip", 0));
    flipAct->setShortcut(tr("Alt+f"));
    //Threshold
    thresholdMenu = new QMenu(this);
    thresholdMenu->setTitle(QApplication::translate("Image", "Thresholds", 0));
    otsuAct = new QAction(this);
    otsuAct->setText(QApplication::translate("Image", "Otsu Threshold", 0));
    otsuAct->setShortcut(tr("Alt+u"));
    otsuMultipleAct = new QAction(this);
    otsuMultipleAct->setText(QApplication::translate("Image", "Otsu Multiple Threshold", 0));
    otsuMultipleAct->setShortcut(tr("Shift+Alt+u"));
    binaryAct = new QAction(this);
    binaryAct->setText(QApplication::translate("Image", "Binary Threshold", 0));
    binaryAct->setShortcut(tr("Shift+Alt+b"));
    bandAct = new QAction(this);
    bandAct->setText(QApplication::translate("Image", "Threshold Outside Band", 0));
    bandAct->setShortcut(tr("Alt+t"));
    aboveAct = new QAction(this);
    aboveAct->setText(QApplication::translate("Image", "Threshold Above", 0));
    aboveAct->setShortcut(tr("Shift+Alt+a"));
    belowAct = new QAction(this);
    belowAct->setText(QApplication::translate("Image", "Threshold Below", 0));
    belowAct->setShortcut(tr("Shift+Alt+b"));
    //Vector imaging
    vectorMenu = new QMenu(this);
    vectorMenu->setTitle(QApplication::translate("Image", "Complex/Vector/4D Imaging", 0));
    vectorMenu->setDisabled(false);
    vectorMagnitudeAct = new QAction(this);
    vectorMagnitudeAct->setText(QApplication::translate("Image", "Display Magnitude", 0));
    vectorMagnitudeAct->setShortcut(tr("Alt+m"));
    vectorComponentAct = new QAction(this);
    vectorComponentAct->setText(QApplication::translate("Image", "Display Component ...", 0));
    vectorComponentAct->setShortcut(tr("Alt+c"));
    pseudoImageAct = new QAction(this);
    pseudoImageAct->setText(QApplication::translate("Image", "Display Pseudo-Image", 0));
    pseudoImageAct->setShortcut(tr("Alt+p"));
    vectorFieldAct = new QAction(this);
    vectorFieldAct->setText(QApplication::translate("Image", "Display Vector/Tensor Field", 0));
    vectorFieldAct->setShortcut(tr("Alt+f"));
    streamLinesAct = new QAction(this);
    streamLinesAct->setText(QApplication::translate("Image", "Display Streamlines from Slice", 0));
    streamLinesAct->setShortcut(tr("Shift+Alt+s"));

    //Display
    levelAct = new QAction(this);
    levelAct->setText(QApplication::translate("Image", "Auto-Level Display", 0));
    levelAct->setShortcut(tr("Alt+o"));
    overlayAct = new QAction(this);
    overlayAct->setText(QApplication::translate("Image", "Overlay Labelled Image from ...", 0));
    overlayAct->setShortcut(tr("Alt+o"));
    overlayContourAct = new QAction(this);
    overlayContourAct->setText(QApplication::translate("Image", "Overlay Labelled Image as Contour from ...", 0));
    overlayContourAct->setShortcut(tr("Shift+Alt+o"));
    blendAct = new QAction(this);
    blendAct->setText(QApplication::translate("Image", "Blend Image with ...", 0));
    blendAct->setShortcut(tr("Shift+Alt+b"));
    volRenderAct = new QAction(this);
    volRenderAct->setText(QApplication::translate("Image", "Display as Volume Rendering", 0));
    volRenderAct->setShortcut(tr("Alt+v"));
    histogramAct = new QAction(this);
    histogramAct->setText(QApplication::translate("Image", "Display Histogram", 0));
    histogramAct->setShortcut(tr("Alt+h"));
    surfacePlotAct = new QAction(this);
    surfacePlotAct->setText(QApplication::translate("Image", "Display Slice Surface Plot", 0));
    surfacePlotAct->setShortcut(tr("Alt+s"));
    surfaceAct = new QAction(this);
    surfaceAct->setText(QApplication::translate("Image", "Display Iso-surface", 0));
    surfaceAct->setShortcut(tr("Shift+Alt+s"));
    polyDataAct = new QAction(this);
    polyDataAct->setText(QApplication::translate("Image", "Generate Polygonal Data", 0));
    ...
    cursorAct->setText(QApplication::translate("Image", "Show Cursor", 0));
...
QMenu* milxQtImage::basicContextMenu()
{
    ...
    contextMenu->setTitle(QApplication::translate("MainWindow", "Imaging", 0));
